"""
GridPass Commander Client - Entry Point
"""
...
def run_headless():
    ...
    print("=" * 60)
    print(f"GridPass Commander v{VERSION} (Headless)")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description="GridPass Commander Client")
    parser.add_argument("--headless", "-H", action="store_true",
                       help="Run without GUI")
    parser.add_argument("--version", "-v", action="version",
                       version=f"GridPass Commander v{VERSION}")
